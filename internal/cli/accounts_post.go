...
func newAccountsPostCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Create / invoke accounts",
		Example:     "  conduyt-crm-pp-cli accounts post",
		Annotations: map[string]string{"pp:endpoint": "accounts.post", "pp:method": "POST", "pp:path": "/accounts"},
