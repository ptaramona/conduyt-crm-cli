...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fmt.Fprintln(w, "  export CONDUYT_CRM_BEARER_AUTH=\"your-token-here\"")
			fmt.Fprintln(w, "  conduyt-crm-pp-cli auth set-token <token>")
			if !launch {
				return nil
			}
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("CONDUYT_CRM_BEARER_AUTH") != "" {
				envStillSet = "CONDUYT_CRM_BEARER_AUTH"
			}
