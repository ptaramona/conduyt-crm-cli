...
type rootFlags struct {
	...
	// invocation. Mirrors the CONDUYT_CRM_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Full-coverage Conduyt CLI: every endpoint, plus Kloudi-grade send-safety forensics no other surface has.`,
		Long: `Full-coverage Conduyt CLI: every endpoint, plus Kloudi-grade send-safety forensics no other surface has.
...
Highlights (not in the official API docs):
  ...
  • contacts verify-line-type   Counts unverified contacts and prints the tenant-paid Twilio cost before the loop (--estimate), then drives the batched verification to done. Requires the account's Phone Line-Type Verification setti…
...
Health check: run 'conduyt-crm-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newBatchOperationsCmd(flags))
	rootCmd.AddCommand(newBillingCmd(flags))
	rootCmd.AddCommand(newBookingPagesCmd(flags))
	rootCmd.AddCommand(newBookingRoutingFormsCmd(flags))
	...
	rootCmd.AddCommand(newDncCmd(flags))
	rootCmd.AddCommand(newDocumentTemplatesCmd(flags))
	rootCmd.AddCommand(newDripCampaignsCmd(flags))
	rootCmd.AddCommand(newDripEnrollmentsCmd(flags))
	rootCmd.AddCommand(newDripTracksCmd(flags))
	...
	rootCmd.AddCommand(newGeneratedDocumentsCmd(flags))
	...
	rootCmd.AddCommand(newKnowledgeCmd(flags))
	rootCmd.AddCommand(newLeadRoutingCmd(flags))
	...
	rootCmd.AddCommand(newPlaybookEnrollmentsCmd(flags))
	...
	rootCmd.AddCommand(newNovelDripsCmd(flags))
	rootCmd.AddCommand(newNovelSendCheckCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAccountPromotedCmd(flags))
	rootCmd.AddCommand(newApiSearchPromotedCmd(flags))
	rootCmd.AddCommand(newBulkOperationsPromotedCmd(flags))
	rootCmd.AddCommand(newContactPromotedCmd(flags))
	rootCmd.AddCommand(newDashboardPromotedCmd(flags))
	rootCmd.AddCommand(newDataModelPromotedCmd(flags))
	rootCmd.AddCommand(newErrorsPromotedCmd(flags))
	rootCmd.AddCommand(newHealthPromotedCmd(flags))
	rootCmd.AddCommand(newLeadPoolPromotedCmd(flags))
	rootCmd.AddCommand(newPhoneNumbersPromotedCmd(flags))
	rootCmd.AddCommand(newTeamPromotedCmd(flags))
	rootCmd.AddCommand(newUpForGrabsPromotedCmd(flags))
