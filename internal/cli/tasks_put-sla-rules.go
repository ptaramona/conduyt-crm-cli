...
func newTasksPutSlaRulesCmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "put-sla-rules",
		Short:       "Update tasks sla-rules",
		Example:     "  conduyt-crm-pp-cli tasks put-sla-rules",
		Annotations: map[string]string{"pp:endpoint": "tasks.put-sla-rules", "pp:method": "PUT", "pp:path": "/tasks/sla-rules"},
