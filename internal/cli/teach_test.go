...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("CONDUYT_CRM_STATE_DIR", "")
	t.Setenv("CONDUYT_CRM_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"conduyt-crm-pp-cli auth login",
		"conduyt-crm-pp-cli doctor",
		"conduyt-crm-pp-cli help items",
		"conduyt-crm-pp-cli sync",
		"conduyt-crm-pp-cli profile list",
		"conduyt-crm-pp-cli feedback list",
		"conduyt-crm-pp-cli which",
		"conduyt-crm-pp-cli agent-context",
		"conduyt-crm-pp-cli completion bash",
		"conduyt-crm-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"conduyt-crm-pp-cli recall",
		"conduyt-crm-pp-cli learnings",
		"conduyt-crm-pp-cli teach-pattern",
		"conduyt-crm-pp-cli teach-lookup",
		"conduyt-crm-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("conduyt-crm-pp-cli")); err == nil {
