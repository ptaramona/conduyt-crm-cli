...
func newWebhooksCreateLegacyCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create-legacy",
		Short:       "Create an outbound webhook endpoint (legacy alias)",
		Example:     "  conduyt-crm-pp-cli webhooks create-legacy --url https://example.com/resource",
		Annotations: map[string]string{"pp:endpoint": "webhooks.create-legacy", "pp:method": "POST", "pp:path": "/webhooks"},
